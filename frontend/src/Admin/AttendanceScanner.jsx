...
//     try {
//       setIsLoading(true);
//       await api.post('/slots/scan-attendance', { qrData: JSON.stringify(qrData) });
...
//       {isLoading && <div className="loading-overlay"><Loader2 className="spinner" /></div>}
...
//           <span className="metric-total">/{queueStatus.totalSpots}</span>
//         )}
//       </span>
//     </div>
...
//           <div className="slot-number">{slot.slot_number + 1}</div>
//           <div className="slot-status">{statusIndicator}</div>
//         </div>
//       );
//     })}
//   </div>
...
//       <div className="legend-color serving"></div>
//       <span>Currently Serving</span>
//     </div>
//     <div className="legend-item">
//       <div className="legend-color your-slot"></div>
